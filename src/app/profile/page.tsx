...
const ProfilePage: React.FC = () => {
  ...
  const openTab = (
    ...
    for (i = 0; i < tablinks.length; i++) {
      (tablinks[i] as HTMLElement).className = tablinks[i].className.replace(
        " active",
        ""
      );
    }
      ...
      <div className="profile-container">
        ...
        <div className="tabs">
          <button
            className="tablinks"
            id="defaultOpen"
            onClick={(e) => openTab(e, "PersonalInfo")}
          >
            Personal Information
          </button>
          <button className="tablinks" onClick={(e) => openTab(e, "Security")}>
            Security
          </button>
        </div>
