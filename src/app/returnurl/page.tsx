  ...
  return (
    <div className="container d-flex align-items-center" style={{height: '100vh'}}>
        <div className="d-flex justify-content-center w-100">
            <div className="payment-complete shadow-lg p-4" style={{width: '60vh', borderRadius: '24px', boxShadow: ''}}>
                <h4 style={{textAlign: 'center'}}>Thanh toán {status == "00" ? "thành công" : "thất bại"}</h4>
                <>
                    <div className="row">
                ...
                <>
                <div className="row">
                    <p>Start date time: {booking.result.startdatetime}</p>
                    <p>End date time: {booking.result.enddatetime}</p>
                </div>
                <div className="row justify-content-between d-flex">
                    <button className="col-4 btn btn-secondary" onClick={handleBack}>Back</button>
                    <button className="col-4 btn btn-primary" onClick={() => handleComplete(booking.result.idbooking) }>Complete</button>
                </div>
                </>
                }
